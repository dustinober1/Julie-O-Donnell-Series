...
|---:|---|---|
| Prologue | Six Years Ago | Accepted |
| 1 | The Official Version | Accepted |
| 2 | The Poisoned Feed | Accepted |
| 3 | The Exit Protocol | Accepted |
| 4 | Burn Notice | Accepted |
| 5 | The Second Clock | Accepted; Chapter 5-to-6 continuity repair integrated |
| 6 | The Descent | Accepted |
| 7 | The Human Key | Accepted |
| 8 | The 05:00 Abort | Accepted |
| 9 | The Life-Safety Override | Accepted |
| 10 | The Capital Connection | Accepted |
| 11 | Going Offensive | Accepted |
| 12 | The Sterling Trap | Accepted |

## Chapter 13 — The Carrier Stream

- **Status:** Accepted canon
- **Path:** `../manuscript/chapters/chapter-13.md`
- **Acceptance review:** `27-chapter-13-acceptance-review.md` — **ACCEPT**
- **Exact words:** 6,175
- **Opening:** approximately 07:18 EDT / 16:48 IST
- **Endpoint:** 07:46:00 EDT / 17:16:00 IST
- **Accepted total after chapter:** 69,830 words
- **Limit preserved:** the physical custodian of the challenged signer remained unresolved

## Chapter 14 — The Witness Line

- **Status:** Accepted canon
- **Path:** `../manuscript/chapters/chapter-14.md`
...
- **Endpoint:** 07:49:32 EDT / 17:19:32 IST
- **Accepted total after chapter:** 75,593 words

## Chapter 15 — The Split Record

- **Status:** Accepted canon
- **Path:** `../manuscript/chapters/chapter-15.md`
...
- **Accepted total after chapter:** 81,586 words
- **Custody result:** seven separate MPD packages; no final federal receiver

## Chapter 16 — The Hold Order

- **Status:** Accepted canon
- **Path:** `../manuscript/chapters/chapter-16.md`
- **Acceptance review:** `33-chapter-16-acceptance-review.md` — **ACCEPT**
...
- **Accepted total after chapter:** 87,610 words
- **Review change:** one surgical equal-count POV-firewall revision in the Sharma movement
- **Endpoint result:** secure MPD intake under Hackett's named preservation hold; no final receiver or accepted technical examiner

## Chapter 17 — The First Examination

- **Status:** Accepted canon
- **Path:** `../manuscript/chapters/chapter-17.md`
...
- **Accepted total after chapter:** 93,498 words
- **POV:** Julie primary; one bounded Special Agent Leila Grant examination-room movement
- **Scope:** `MPD-901446` only; the other six packages remained sealed and unopened
- **Custody:** MPD retained all seven packages; `MPD-901446` was resealed under `MPD-SL-551821`
