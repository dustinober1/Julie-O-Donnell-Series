...
The historical mission-lock and acceptance files remain useful provenance for Chapter 24, but their former word-count and exact-endpoint metadata do not supersede the current accepted manifest.

- Chapter 24 mission lock: `48-chapter-24-mission-lock.md`
- Chapter 24 acceptance review: `49-chapter-24-acceptance-review.md`
- Chapter 24 accepted prose: `../manuscript/chapters/chapter-24.md`
- No Chapter 25 artifact is authorized.

## Ending controls

- `22-book-1-ending-contract.md` records the ending obligations.
- `24-thread-disposition-matrix.md` separates paid Book 1 threads from deliberate series carryovers.
- `25-chapter-acceptance-gate.md` remains the standing chapter-acceptance method.
- `49-chapter-24-acceptance-review.md` remains historical acceptance evidence for the final chapter.
- The current accepted word count and file hashes come only from `../ACCEPTED_MANUSCRIPT.yaml`.
