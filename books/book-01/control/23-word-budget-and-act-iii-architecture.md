...
| Accepted manuscript through Chapter 20 | **107,676** |
| Above minimum | **7,676** |
| Remaining to planning target | **4,824** |
| Remaining before maximum | **17,324** |

| Unit | Accepted words |
|---|---:|
| Prologue and Chapters 1–12 | 63,655 |
| Chapters 13–19 | 39,714 |
| Chapter 20 — The Custody Exception | 4,307 |
| Accepted Act III subtotal, Chapters 13–20 | **44,021** |
| Accepted manuscript total | **107,676** |

The count method is `len(Path(path).read_text(encoding='utf-8').split())`, implemented by `tools/count_book1_words.py`.

## Accepted Chapter 20 function
