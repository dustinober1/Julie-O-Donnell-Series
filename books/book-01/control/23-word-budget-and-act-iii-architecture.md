...
| Accepted manuscript through Chapter 14 | 75,593 |
| Remaining to planning target | 36,907 |
| Remaining to minimum | 24,407 |
| Remaining before maximum | 49,407 |

Chapter 13 contributes 6,175 accepted words. Chapter 14 contributes 5,763 accepted words. Prologue and Chapters 1–12 contribute 63,655 accepted words under the same whitespace-delimited method.

Accepted word counts do not change during mission planning or drafting. They change only when prose is formally accepted and promoted.

## Planning principle

The remaining Chapter 15–resolution manuscript should normally land between **32,500 and 43,500 new accepted words**, producing a likely first-draft total between approximately **108,093 and 119,093 words** before final cuts or additions.
...
The later rows below predate the Chapter 15 lock and remain high-level, provisional production planning. They are not a complete controlling outline and may be changed only through later chapter-specific mission locks.
