...
| Accepted manuscript through Chapter 21 | **112,091** |
| Above minimum | **12,091** |
| Remaining to planning target | **409** |
| Remaining before maximum | **12,909** |

| Unit | Accepted words |
|---|---:|
| Prologue and Chapters 1–12 | 63,655 |
| Chapters 13–20 | 44,021 |
| Chapter 21 — The Borrowed Name | 4,415 |
| Accepted Act III subtotal, Chapters 13–21 | **48,436** |
| Accepted manuscript total | **112,091** |

The count method is `len(Path(path).read_text(encoding='utf-8').split())`, implemented by `tools/count_book1_words.py`.

## Accepted Chapter 21 function
...
- early mechanism-versus-human complication;
- midpoint distinction between failed local commit and distinct later release;
- separately corroborated personal Vance release finding;
- Julie's costly scope decision and Alvarez's independent consequence decision;
...
- Price, Marcus, Elias, Chen, Mercer, Bell, and institutional aftermath at the ending-contract level;
- medical and legal stabilization without convenient exoneration or recovery;
