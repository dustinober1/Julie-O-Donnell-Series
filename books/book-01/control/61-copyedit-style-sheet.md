...
- Canonical prose consists only of the manifest-listed Prologue and Chapters 1–24, in manifest order.
- Generated compilations, archived drafts, historical Word files, Google Docs, and review exports are not source text.
- The accepted final line is **The bubble stayed centered.** Preserve it exactly.
- Plot, chronology, scene order, POV order, character decisions and knowledge, clues, technical and legal mechanisms, evidence, proof ceilings, chapter openings, chapter endings, and suspense structure are content locked.
- This pass corrects grammar, punctuation, dialogue mechanics, spelling, usage, compounds, capitalization, formatting, and unambiguous attribution only.

## General style

- Use American English and conventional U.S. trade-fiction practice.
- Use the serial comma in ordinary prose.
- Use smart double quotation marks and smart apostrophes in prose.
- Close em dashes against surrounding words—no spaces.
- Use em dashes for interrupted speech. Use three-dot ellipses only for genuine trailing speech or thought; do not introduce spaced-dot ellipses.
- Preserve intentional fragments, clipped internal thought, short paragraphs, one- or two-word sentences, countdown beats, tactical dialogue, and chapter-end hooks.
...
- Dialogue meaning, professional register, contractions, profanity, hesitation, evasiveness, and operational shorthand are locked.
- Dialogue tags take commas. Action beats remain complete sentences.
- Start a new paragraph when the speaker changes.
- Do not attach one speaker’s dialogue to another character’s action beat.
- Do not make military, intelligence, technical, legal, medical, or police professionals unnaturally formal to satisfy textbook grammar.
- Preserve character-specific rhythms; do not assign Julie’s evidence-testing cadence mechanically to the rest of the cast.
...
- Capitalize formal agency, office, facility, system, unit, and operation names; lowercase generic descriptive uses.
...
- Do not imply personal responsibility by changing a generic institutional reference into a formal personal title.
...
- Narrative percentages use `94.1 percent`, `99.8 percent`, `8.4 percent`, and `0.07 percent`; displays may use `%` when already established.
...
- Keep blank lines around display blocks when needed for readability.
- Literal interface text may retain hyphens, slashes, colons, periods, and digits that are not typographically normalized.
- Expand acronyms on first natural use only when the manuscript requires it. Do not repeatedly re-expand established terms.

## Character list and physical continuity

### Principal cast

- **Julie M. O’Donnell** — Julie; she/her. Smart apostrophe and double `l`. Former Army intelligence officer. Right wrist/forearm injured during the lower-tier escape; later braced and substantially unusable for grip. Left hand becomes functional for writing, steering, and evidence-adjacent actions.
- **Marcus L. Reed** — Marcus; he/him. Colonel / Army officer. Rib injury, right-thigh trauma, scalp wound above the right ear, damaged boot/heel, intermittent oxygen need, and concussion observation.
- **Elias M. Thorne** — Elias; he/him. Argus model developer. Left-hip injury, right-index-finger cut used for live biometric acts, cold exposure, and dizziness. Administrator-token board remains tied to his identity and custody history.
...
- **Sarah Chen** — Sarah; she/her. Apex contractor integration/compliance. Preserve the distinctions among her containment actions, force restrictions, source preservation, later cooperation, and access suspension.
...
- **Major Ananya Sharma** — Sharma; she/her. Indian battery commander and local decision-maker. Her no-fire decision remains her command act.
...
- **Diane Kessler** — Kessler; she/her. Sterling-office deputy national-security director; continuity-exception authorizer, not established instruction source.
- **Nora Bell** — Bell; she/her. Northbridge facilities/technical watch; preserves the local WSS-4 record within her scope.
- **Sergeant Tom Baines** — Baines; he/him. Prologue.
- **Lieutenant Colonel Daniel Hargrove** — Hargrove; he/him. Prologue; retain rank appropriate to that scene date.

## Organizations, units, and locations

Use these exact forms according to context:
...
- Indian Northern Command / Northern Command, according to context.
...
Use the established context-specific names without merging distinct objects:

- Aluminum incident-capture case / aluminum telemetry case.
...
- Release from custody or a decision not to charge that day is not a judicial finding of innocence and does not bar later lawful process.
...
## Preferred and avoided rhetorical forms
...
- reintroducing repeated `Not X. Not Y. Z.` templates.
- turning proof-limited language into categorical accusation or exoneration.
- replacing operationally distinct terms with synonyms for variety.
- expanding intentional fragments merely to lengthen sentences.
- combining short paragraphs merely because several appear together.
- conducting another line edit or AI-voice pass under the copyedit label.
