...
- Accepted canon: Prologue and Chapters 1–18
- Accepted-manuscript length: **97,976 words**
- Accepted endpoint: **10:01:12 EDT / 19:31:12 IST**
- Chapter 18, **The Local Record**: accepted at **4,478 words**
...
## Accepted Chapter 18 endpoint

- Major Ananya Sharma remains the only close-third viewpoint.
- K-17 remained physically intact when inspected; the patrol did not cross the inner security boundary.
- Security Line One recorded an accepted pass.
- `K17-PHASE-B` reached the relay controller under authority registered to `TARIQ, MAJOR / FORWARD LIAISON CELL`.
